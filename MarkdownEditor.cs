...
namespace MEditor
{
    public class MarkdownEditor
    {
        ...
        private void createRTB(ref TextEditor htmlRtb)
        {
            ...
            htmlRtb.ShowLineNumbers = true;
            //htmlRtb.HighlightCurrentLine = true;
            htmlRtb.Options.HighlightCurrentLine = true;
            htmlRtb.Options.ShowColumnRuler = true;
            htmlRtb.Options.WordWrapIndentation = 8;

            //FoldingManager.Install(htmlRtb.TextArea);
        }
        ...
        public bool Openfile(string file)
        {
            ...
            if (_previewBrowser.InvokeRequired)
            {
                _previewBrowser.Invoke(new Action(() => { _previewBrowser.DocumentText = text; }));
            }
            else
            {
